...
const Landing = () => {
  ...
  return (
    <PageLayout>
      ...
      <section className='px-6 py-20 font-haas_roman text-center md:px-20 lg:px-28 lg:py-36 3xl:py-52 4xl:px-72'>
      ...
      <section className='bg-leafs bg-cover font-haas_roman bg-center h-full text-primary px-6 py-20 md:px-20 lg:px-28 lg:py-36 lg:grid lg:grid-cols-2 lg:gap-x-20 3xl:py-52 4xl:px-72'>
        <div>
      ...
      <section className='px-6 py-20 bg-accent space-y-8 md:px-20 lg:px-28 lg:py-36 lg:grid lg:grid-cols-2 lg:gap-x-20 lg:space-y-0 4xl:px-72'>
